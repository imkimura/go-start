...
import (
	...
	"gibhub.com/imkimura/golang-start/internal/store/pgstore"
...
func (h apiHandler) handleGetRooms(w http.ResponseWriter, r *http.Request) {
	...
	data, _ := json.Marshal(response{Message: "No room has been found yet."})
...
func (h apiHandler) handleGetRoom(w http.ResponseWriter, r *http.Request) {
	...
	roomData, err := h.q.GetRoom(r.Context(), roomId)
...
func (h apiHandler) handleCreateRoomMessage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		slog.Warn("failed to insert message", "error", err)
		http.Error(w, "something went wrong", http.StatusInternalServerError)
		return
	}
...
func (h apiHandler) handleGetRoomMessage(w http.ResponseWriter, r *http.Request) {
	...
	messageData, err := h.q.GetMessage(r.Context(), messageId)
